...
function update_status(id){
	...
	var myurl = baseUrl+'adminmedia/employers/status/'+id+'/'+current_status;
...
function update_top_employer_status(id){
	...
	var myurl = baseUrl+'adminmedia/employers/top_employer_status/'+id+'/'+current_status;
	$.get(myurl, function (sts) {
		var class_label = 'success';
		if(sts!='yes')
...
function update_top_industry_status(id){
	...
	var myurl = baseUrl+'adminmedia/industries/top_industry_status/'+id+'/'+current_status;
	$.get(myurl, function (sts) {
		var class_label = 'success';
		if(sts!='yes')
			var class_label = 'warning';
...
function delete_employer(id){
	var myurl = baseUrl+'adminmedia/employers/delete_employer/'+id;
...
function update_job_seeker_status(id){
	var current_status = $("#sts_"+id+" span").html();
	var myurl = baseUrl+'adminmedia/job_seekers/status/'+id+'/'+current_status;
	$.get(myurl, function (sts) {
		var class_label = 'success';
		if(sts!='active')
			var class_label = 'danger';
...
function delete_job_seeker(id){
	var myurl = baseUrl+'adminmedia/job_seekers/delete_job_seeker/'+id;
...
function update_posted_job_status(id){
	var current_status = $("#sts_"+id+" span").html();
	var myurl = baseUrl+'adminmedia/posted_jobs/status/'+id+'/'+current_status;
	$.get(myurl, function (sts) {
		var class_label = 'success';
		if(sts!='active')
			var class_label = 'danger';
...
function delete_posted_job(id){
	var myurl = baseUrl+'adminmedia/posted_jobs/delete_posted_job/'+id;
...
function update_featured_job(id){
	...
	var myurl = baseUrl+'adminmedia/posted_jobs/featured_status/'+id+'/'+current_status;
	$.get(myurl, function (sts) {
		var class_label = 'success';
		if(sts!='yes')
			var class_label = 'warning';
...
function update_cms_status(id){
	var current_status = $("#sts_"+id+" span").html();
	var myurl = baseUrl+'adminmedia/cms/status/'+id+'/'+current_status;
	$.get(myurl, function (sts) {
		var class_label = 'success';
		if(sts!='active')
			var class_label = 'danger';
...
function delete_cms(id){
	var myurl = baseUrl+'adminmedia/cms/delete/'+id;
...
function delete_salary(id){
	var myurl = baseUrl+'adminmedia/salary/delete/'+id;
...
function load_salary_edit_form(id){
	$.getJSON(baseUrl+'adminmedia/salary/get_salary_by_id/'+id, function(data) {
...
function delete_qualification(id){
	var myurl = baseUrl+'adminmedia/qualification/delete/'+id;
...
function load_qualification_edit_form(id){
	$.getJSON(baseUrl+'adminmedia/qualification/get_qualification_by_id/'+id, function(data) {
...
function update_industries_status(id){
	var current_status = $("#sts_"+id+" span").html();
	var myurl = baseUrl+'adminmedia/industries/status/'+id+'/'+current_status;
	$.get(myurl, function (sts) {
		var class_label = 'success';
		if(sts!='active')
			var class_label = 'danger';
...
function delete_industries(id){
	var myurl = baseUrl+'adminmedia/industries/delete/'+id;
...
function load_industries_edit_form(id){
	...
	$.getJSON(baseUrl+'adminmedia/industries/get_industries_by_id/'+id, function(data) {
...
function update_institute_status(id){
	var current_status = $("#sts_"+id+" span").html();
	var myurl = baseUrl+'adminmedia/institute/status/'+id+'/'+current_status;
	$.get(myurl, function (sts) {
		var class_label = 'success';
		if(sts!='active')
			var class_label = 'danger';
...
function delete_institute(id){
	var myurl = baseUrl+'adminmedia/institute/delete/'+id;
...
function load_institute_edit_form(id){
	...
	$.getJSON(baseUrl+'adminmedia/institute/get_institute_by_id/'+id, function(data) {
...
function update_stories_status(id){
	var current_status = $("#sts_"+id+" span").html();
	var myurl = baseUrl+'adminmedia/stories/status/'+id+'/'+current_status;
	$.get(myurl, function (sts) {
		var class_label = 'success';
		if(sts!='active')
			var class_label = 'danger';
...
function delete_stories(id){
	var myurl = baseUrl+'adminmedia/stories/delete/'+id;
	var is_confirm = confirm("Are you sure you want to delete this institute?");
	if(is_confirm){
		  $.get(myurl, function (sts) {
			  if(sts=='done')
...
function load_stories_edit_form(id){
	...
	$.getJSON(baseUrl+'adminmedia/stories/get_stories_by_id/'+id, function(data) {
...
function update_cities_status(id){
	...
	var myurl = baseUrl+'adminmedia/cities/status/'+id+'/'+current_status;
...
function delete_cities(id){
	var myurl = baseUrl+'adminmedia/cities/delete/'+id;
...
function load_cities_edit_form(id){
	...
	$.getJSON(baseUrl+'adminmedia/cities/get_city_by_id/'+id, function(data) {
...
function delete_countries(id){
	var myurl = baseUrl+'adminmedia/countries/delete/'+id;
...
function load_countries_edit_form(id){
	...
	$.getJSON(baseUrl+'adminmedia/countries/get_country_by_id/'+id, function(data) {
...
function load_quick_job_view(emp_id, comp_name){
	...
	$.getJSON(baseUrl+'adminmedia/posted_jobs/latest_job_by_company/'+emp_id, function(data) {
...
$(document).ready(function(){
 $("#frm_employer #email").blur(function(){
	 $.ajax({
				type: "POST",
				url: baseUrl+"adminmedia/employers/check_email_address",
...
function load_prohibited_edit_form(id){
	$.getJSON(baseUrl+'adminmedia/prohibited_keyword/get_prohibited_keyword_by_id/'+id, function(data) {
...
function delete_prohibited(id){
	var myurl = baseUrl+'adminmedia/prohibited_keyword/delete/'+id;
...
function load_skill_edit_form(id){
	...
	$.getJSON(baseUrl+'adminmedia/skills/get_skill_by_id/'+id, function(data) {
...
function update_skill_frequency(id, keyword){
 ...
 $.ajax({
		  type: "POST",
		  url: baseUrl+"adminmedia/skills/update_skill_frequency",
...
function add_skill_frequency(id, keyword){
 ...
 $.ajax({
		  type: "POST",
		  url: baseUrl+"adminmedia/skills/add_skill_frequency",
...
function delete_skill(id){
	var myurl = baseUrl+'adminmedia/skills/delete/'+id;
...
function load_quick_job_preview(job_id, comp_name){
	$('#quick_job').modal('show');
	$("#j_comp_name").html(comp_name);
	$.getJSON(baseUrl+'adminmedia/posted_jobs/job_by_id/'+job_id, function(data) {
