   ...
   <section class="content">
      ...
      <div class="message-container">
         <div class="callout callout-success">
            <h4>New Question has been created successfully.</h4>
         </div>
      </div>
      @endif
      <div class="row">
      ...
      <form enctype="multipart/form-data" role="form" method="post"
         action="{{route('question_update',$result->id)}}">
         @csrf
         ...
         <div class="form-group">
            ...
            <option value="{{$package->id}}" @if($result->package_id==$package->id)
            selected=""
            @endif>{{$package->heading}}</option>
            @endforeach
            </select>
         </div>
         <div class="form-group">
            ...
            <select class="form-control" id="additional_fields" name="additional_fields"
               ...
               <option value="1" @if($result->pattern=='radio')
               selected=""
               @endif>Radio Pattern</option>
               <option value="2"  @if($result->pattern=='check')
               selected=""
               @endif>Checkbox Pattern</option>
               <option value="3" @if($result->pattern=='input')
               selected=""
               @endif>Input Pattern</option>
            </select>
         </div>
