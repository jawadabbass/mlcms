...
<h2> <i class="fa-solid fa-plus-circle" aria-hidden="true"></i> Add Contact Lead</h2>
...
<form method="post" name="frm" id="frm" action="{{route('contact_request.store')}}"  enctype="multipart/form-data">
    @csrf

<br>
<div class="row" style="margin-bottom: 10px;">
              <div class="col-lg-3 text-end">Name</div>
              <div class="col-lg-6"><input type="text" name="name" id="name" class="form-control" value="{{old('name')}}" placeholder=""></div>
              <div class="col-lg-3 text-start"></div>
          </div>

<div class="row" style="margin-bottom: 10px;">
              <div class="col-lg-3 text-end">Email</div>
              <div class="col-lg-6"><input type="text" name="email" id="email" class="form-control" value="{{old('email')}}" placeholder=""></div>
              <div class="col-lg-3 text-start"></div>
          </div>

<div class="row" style="margin-bottom: 10px;">
              <div class="col-lg-3 text-end">Phone</div>
              <div class="col-lg-6"><input type="text" name="phone" id="phone" class="form-control" value="{{old('phone')}}" placeholder=""></div>
              <div class="col-lg-3 text-start"></div>
          </div>
...
<div class="row" style="margin-bottom: 10px;">
              ...
              <div class="col-lg-6">
                <input type="date" name="dated" id="dated" class="form-control" value="{{ old('dated') ?? date('Y-m-d')}}" placeholder="">
              </div>
              <div class="col-lg-3 text-start"></div>
          </div>
