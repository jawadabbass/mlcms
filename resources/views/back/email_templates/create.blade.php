                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <form id="validatethis" name="myForm" method="post"
                            action="{{ route('email_templates.store') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                ...
                                <div id="user_email_area">
                                    <div class="row" style="margin-top:10px;">
                                        <div class="col-sm-12">
                                            ...
                                            @endphp
                                            <textarea name="user_body" id="user_body" class="form-control" required=""></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
...
@section('beforeBodyClose')
    ...
    <script src="{{ asset('back/js/plugins/editor/ckeditor/ckeditor.js') }}"></script>
