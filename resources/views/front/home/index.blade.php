                ...
                @foreach ($get_all_banner as $banner)
                    ...
                    <div class="item {{ $b_class }}">
                        <div class="slider-thumb bg-fixed"
                            style="background-image: url({{ asset('uploads/module/banner/' . $banner->featured_img) }});">
                        </div>
                ...
                <div class="col-md-12">
                    <div class="services-items services-carousel owl-carousel owl-theme">
                        @foreach ($get_all_services as $service)
                            ...
                            <div class="item">
                                <div class="thumb"> <img
                                        src="{{ asset('uploads/module/services/' . $service->featured_img) }}"
                    ...
                    <div class="management-items management-carousel owl-carousel owl-theme">
                        @foreach ($get_all_testimonials as $testimonial)
                            ...
                            <div class="item">
                                ...
                                <div class="author">
                                    <div class="thumb"> <img
                                            src="{{ asset('uploads/module/testimonials/' . $testimonial->featured_img) }}"
                    ...
                    <div class="clients-items owl-carousel owl-theme text-center">
                        @foreach ($get_all_partners as $partner)
                            <div class="single-item">
                                <a href="#">
                                    <img src="{{ asset('uploads/module/partners/' . $partner->featured_img) }}"
