...
<head>
  ...
  <link href="<?php echo base_url('public/module/blog/front/css/blog.css'); ?>" rel="stylesheet" type="text/css" />
              ...
              <li class="col-md-12">
                <div class="inner-col">
                  <div class="articles-image">
                    <?php if (file_exists('public/uploads/blog/thumb/'.$blogsValues['featured_img']) && !empty($blogsValues['featured_img'])) { ?>
                      <img src="<?php echo front_uploads().'blog/thumb/'.$blogsValues['featured_img']; ?>"  title="<?php echo $blogsValues['featured_img_title']; ?>"  alt="<?php echo $blogsValues['featured_img_alt']; ?>">
                    <?php } else { ?>
                      <img src="<?php echo upload_url().'public/images/admin_images/no_image.jpg'; ?>" title="<?php echo $blogsValues['featured_img_title']; ?>"  alt="<?php echo $blogsValues['featured_img_alt']; ?>">
                    <?php } ?>
                  </div>
                  <div class="head">
