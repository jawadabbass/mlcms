...
function load_ministries_edit_form(id) {
    ...
    $.getJSON(baseUrl + 'ministries/get_ministries_by_id/' + id, function (data) {
        ...
        $("#bannerimages").attr('src', asset_uploads+'ministers/thump/' + data.banner_name);
...
function load_games_edit_form(id) {
    ...
    $.getJSON(baseUrl + 'games/get_games_by_id/' + id, function (data) {
        ...
        if (data.games_img == null || data.games_img == '' || data.games_img == 0) {
            ...
            $("#featured_img").fadeIn();
            var img = '<div class="featured-images-main" id="games_img_' + data.ID + '"><img style="width:150px" src="' + asset_uploads + 'games/thumb/' + data.games_img + '"><i onClick="remove_games_featured_image(' + data.ID + ');" class="deleteIcon"></i></div>';
            $('#featured_img').html('');
            $('#featured_img').append(img);
        }
...
function load_banners_edit_form(id) {
    ...
    $.getJSON(baseUrl + 'banners/get_banners_by_id/' + id, function (data) {
        ...
        $("#bannerimages").attr('src', asset_uploads+'banners/thumb/' + data.banner_name);
...
function load_testimonials_edit_form(id) {
    ...
    $.getJSON(baseUrl + 'testimonials/get_testimonials_by_id/' + id, function (data) {
        ...
        $('#edit_designation').val(data.designation);
        $("#testimonialsimages").attr('src', asset_uploads+'testimonials/thumb/' + data.image);
        //alert(data.gallery_desc);
        // tinyMCE.activeEditor.execCommand('mceCleanup', false);
        tinyMCE.get('edit_editor1').setContent('');
...
function load_widgets_edit_form(id) {
    ...
    $.getJSON(baseUrl + 'adminmedia/widgets/' + id, function (data) {
        ...
        var filename = asset_uploads+'widgets/thumb/' + data.featured_image;
        $("#widgetsimages").attr('src', filename);
        // alert('HELLO TESTING HERE');

        var img = '<div class="featured-images-main" id="products_img_' + data.ID + '"><img style="width:150px" src="' + asset_uploads + 'widgets/' + data.featured_image + '"><i onClick="remove_widget_image(' + data.ID + ');" class="deleteIcon"></i></div>';
...
function load_color_cate_edit_form(id) {
    ...
    $.getJSON(baseUrl + 'color_categories/get_color_cate_by_id/' + id, function (data) {
        $('#edit_title').val(data.title);
        //var filename = asset_uploads+'color_cate/thumb/'+data.featured_image;
...
function load_product_cate_edit_form(id) {
    ...
    $.getJSON(baseUrl + 'product_category/get_product_cate_by_id/' + id, function (data) {
        $('#edit_title').val(data.title);
        var filename = asset_uploads+'product_cate/thumb/' + data.featured_image;
        $("#featured_image").attr('src', filename);
    ...
    $.getJSON(baseUrl + 'products/get_products_by_id/' + id, function (data) {
        ...
        if (data[0]['images'].length > 0) {
            for (var i = 0; i < data[0]['images'].length; i++) {
                var img = '<li id="products_img_' + data[0]['images'][i].ID + '"><img src="' + asset_uploads + 'products_images/thumb/' + data[0]['images'][i].image_name + '"><i onClick="delete_uploaded_images(' + data[0]['images'][i].ID + ');" class="deleteIcon"></i></li>';
...
function load_stocked_colors_edit_form(id) {
    ...
    $.getJSON(baseUrl + 'stocked_colors/get_color_stock_by_id/' + id, function (data) {
        ...
        var filename = asset_uploads+'stocked_colors/thumb/' + data.featured_image;
        $("#featured_image").attr('src', filename);
...
function load_page_edit_form(id) {
    ...
    $.getJSON(baseUrl + 'pages/get_page_by_id/' + id, function (data) {
        ...
        if (data.featured_img == null || data.featured_img == '' || data.featured_img == 0) {
            ...
            $("#pageimages").attr('src', asset_uploads+'pages/thumb/' + data.featured_img);
        }
        //tinymce.activeEditor.execCommand('mceInsertContent', false, data.content);
...
function load_video_edit_form(id) {
    ...
    $.getJSON(baseUrl + 'videos/get_video_by_id/' + id, function (data) {
        ...
        //                    var img = '<div class="featured-images-main" id="products_img_'+data.ID+'"><img style="width:150px" src="'+asset_uploads+'social-media-icons/'+data.icon_img+'"><i onClick="remove_social_media_icon_image('+data.ID+');" class="deleteIcon"></i></div>';
        //                   $('#featured_img').html('');
        //                    $('#featured_img').append(img);
        //                }
        //       $("#icon_img").attr('src', asset_uploads+'social-media-icons/'+data.icon_img);
        //       ckeditors['edit_editor1'].setData(data.banner_desc);
...
function load_project_edit_form(id) {
    ...
    $.getJSON(baseUrl + 'projects/get_project_by_id/' + id, function (data) {
        ...
        if (data[0]['images'].length > 0) {
            for (var i = 0; i < data[0]['images'].length; i++) {
                var img = '<li id="products_img_' + data[0]['images'][i].ID + '"><img src="' + asset_uploads + 'projects_images/thumb/' + data[0]['images'][i].image_name + '"><i onClick="delete_uploaded_project_images(' + data[0]['images'][i].ID + ');" class="deleteIcon"></i></li>';
                $('#pro_uploaded_images').append(img);
            }
        }
    });
...
function load_customers_edit_form(id) {
    ...
    $.getJSON(baseUrl + 'customers/get_customers_by_id/' + id, function (data) {
        ...
        $("#bannerimages").attr('src', asset_uploads+'customers/thumb/' + data.logo_images);
