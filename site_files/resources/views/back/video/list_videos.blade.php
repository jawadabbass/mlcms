                                    ...
                                    @forelse($moduleMembers as $moduleMember)
                                        <tr>
                                            @if ($module->show_featured_image == 1)
                                                <td>
                                                    @if (!empty($moduleMember->featured_img))
                                                        <img width="100"
                                                            src="{{ asset_uploads('') . 'module/' . $module->type . '/thumb/' . $moduleMember->featured_img }}">
                                                    @else
                                                        <img width="100"
                                                            src="{{ asset_uploads('') . 'module/' . $module->type . '/thumb/no-image.jpg' }}">
                                                    @endif
                                                </td>
                                            @endif
                                            <td>
                                            ...
                                            <td> <a class="btn btn-sm btn-primary"
                                                    href="{{ admin_url() }}testimonial/edit/{{ $moduleMember->id }}"
                                                    title="Edit"><i class="glyphicon glyphicon-pencil"></i> Edit</a> <a
                                                    class="btn btn-sm btn-danger" href="javascript:void(0)" title="Delete"
