                ...
                <div class="col-md-12">
                    <div class="mb-2">
                        <label class="form-label">
                            <input id="restrict_traffic" name="restrict_traffic" type="checkbox" data-toggle="toggle"
                                data-on="On" data-off="Off" onclick="show_hide('#restrict_area',false);"
                                data-onstyle="success" data-offstyle="danger"
                                {{ $metaArray['restrict_traffic'] ? 'checked' : '' }}>
                ...
                <div class="col-md-4 col-sm-5">
                    <div class="blockarea">
                        ...
                        <div class="formrow">
                            <strong>
                                <span class="radiobtn">
                                    <input type="radio" name="blocked_area" id="blockedContact1" value="contact_us"
                        ...
                        <div class="formrow">
                            <strong>
                                <span class="radiobtn">
                                    <input type="radio" name="blocked_area" id="blockedContact2" value="website"
