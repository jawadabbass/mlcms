                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 text-end top_action_btn">
                                ...
                                <a class="btn btn-md btn-info" title="Edit"
                                    href="{{ admin_url() }}mod/step/1">{!! the_icon('add') !!} Add</a>
                                <?php }?>
      ...
      ?>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-sm btn-info" title="Edit"
                                                        href="<?php echo admin_url() . $settingArr['contr_name'] . '/step/3/' . $row->$idf; ?>"> Actions</a>

                                                    <a class="btn btn-sm btn-info" title="Edit"
                                                        href="<?php echo admin_url() . $settingArr['contr_name'] . '/step/4/' . $row->$idf; ?>"> Generate Code</a>
                                                    <br>

                                                    <a class="btn btn-sm btn-info" target="_blank" title="View Module"
                                                        href="<?php echo admin_url() . $row->mod_url; ?>"> View Module</a>
