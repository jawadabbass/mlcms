                    ...
                    <div class="card p-2">
                        <div class=" card-body">
                            ...
                            <form method="post" name="frm" id="frm"
                                action="{{ admin_url() }}invoice/{{ $clientObj->id }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col-lg-6"><input type="text" name="name" id="name"
                                            class="form-control" value="{{ old('name') ?? $clientObj->name }}"
                                            placeholder=""></div>
                                ...
                                <div class="row" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col-lg-6"><input type="text" name="email" id="email"
                                            class="form-control" value="{{ old('email') ?? $clientObj->email }}"
                                            placeholder=""></div>
                                    <div class="col-lg-3 text-start"></div>
                                </div>
                                <div class="row" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col-lg-6"><input type="text" name="phone" id="phone"
                                            class="form-control" value="{{ old('phone') ?? $clientObj->phone }}"
                                            placeholder=""></div>
                                    <div class="col-lg-3 text-start"></div>
                                </div>
                                <div class="row" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="date" name="dated" id="dated" class="form-control"
                                            value="{{ old('dated') ?? date('Y-m-d', strtotime($clientObj->dated)) }}"
                                            placeholder="">
                                    </div>
                                    <div class="col-lg-3 text-start"></div>
                                </div>
