        ...
        <div class="container">
            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                    ...
                    <form name="store_admin_user" id="store_admin_user" method="POST" action="{{ route('admin.user.store') }}">
                        ...
                        <div class="tab-content" id="user_rolesContent">
                            ...
                            <div class="tab-pane fade mt-3" id="user_roles-tab-pane" role="tabpanel"
                                ...
                                <div class="form-group">
                                    ...
                                    <br/>
                                    <label class="text-default"><input type="checkbox" id="selectAllRoles" value="1" onclick="selectAllCheckBoxes();">&nbsp;&nbsp;&nbsp;Select All</label>
