<script src="{{ public_path_to_storage('back/js/jquery.min.js') }}"></script>
<script src="{{ public_path_to_storage('back/jquery-ui/jquery-ui.min.js') }}"></script>
<script src="{{ public_path_to_storage('back/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
<script type="text/javascript" src="{{ public_path_to_storage('back/js/js/effects.js') }}"></script>
<script type="text/javascript" src="{{ public_path_to_storage('back/js/js/popupjs.js') }}"></script>
<script type="text/javascript" src="{{ public_path_to_storage('back/js/js/get_auto.js') }}"></script>
<script src="{{ public_path_to_storage('back/fontawesome-iconpicker/dist/js/fontawesome-iconpicker.min.js') }}"></script>
<script src="{{ public_path_to_storage('back/js/plugins/timepicker/bootstrap-timepicker.min.js') }}" type="text/javascript"></script>
<script src="{{ public_path_to_storage('back/js/functions.js') }}" type="text/javascript"></script>
<script type="text/javascript" src="{{ public_path_to_storage('back/js/plugins/datatables/jquery.dataTables.js') }}"></script>
<script src="{{ public_path_to_storage('module/module/admin/filer/js/jquery.filer.min.js') }}"></script>
<script src="https://cdn.ckeditor.com/ckeditor5/36.0.1/super-build/ckeditor.js"></script>
<script src="{{ public_path_to_storage('back/js/admin_functions.js?v=22') }}" type="text/javascript"></script>
<script src="{{ public_path_to_storage('select2/js/select2.full.min.js') }}" type="text/javascript"></script>
<script src="{{ public_path_to_storage('back/datetimepicker/build/jquery.datetimepicker.full.min.js') }}" type="text/javascript">
</script>
<script src="{{ public_path_to_storage('back/js/AdminLTE/dist/js/adminlte.min.js') }}"></script>
