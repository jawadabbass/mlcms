...
<script type="text/javascript" src="{{ asset_storage('back/js/js/effects.js') }}"></script>
<script type="text/javascript" src="{{ asset_storage('back/js/js/popupjs.js') }}"></script>
<script type="text/javascript" src="{{ asset_storage('back/js/js/get_auto.js') }}"></script>
<script src="{{ asset_storage('back/fontawesome-iconpicker/dist/js/fontawesome-iconpicker.min.js') }}"></script>
<script src="{{ asset_storage('back/js/plugins/timepicker/bootstrap-timepicker.min.js') }}" type="text/javascript"></script>
<script src="{{ asset_storage('back/js/functions.js') }}" type="text/javascript"></script>
...
<script src="{{ asset_storage('back/datetimepicker/build/jquery.datetimepicker.full.min.js') }}" type="text/javascript">
</script>
