                    ...
                    <div class="box">
                        <div class="box-body">
                            <div class="row">
                                ...
                                @if (count($contactReferrerArray) > 0)
                                        ...
                                        <table class="table table-bordered table-inverse table-hover">
                                            ...
                                            <tbody>
                                                @php
                                                    ...
                                                    $BGcolor = '';
                                                @endphp
                                                @foreach ($contactReferrerArray as $row)
                                                    @php
                                                        $bgColor =
                                                    ...
                                                    <tr>
                                                        <td>{{ $row['referrer'] }} <a href="javascript:void(0);"
                                                                ...
                                                                class="btn btn-danger"><i class="fa fa-external-link"
                                                        ...
                                                        <td>
                                                            ...
                                                            @if ($row['totalLeadsByReferrerCount'] > 0)
                                                                <a class="btn btn-sm btn-success" target="_blank"
                                                                    href="{{ url('adminmedia/contact_data_request?dates=' . request()->input('dates', '') . '&referrer_url_id=' . $row['id']) }}">
