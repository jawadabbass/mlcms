...
class paypal_lib {
	...
	function __construct()
	{
		...
		$testMode=false;
		if(get_meta_val('paypal_test')=='Yes'){$testMode=true;}
		
		$this->paypal_url = ($testMode)?'https://www.sandbox.paypal.com/cgi-bin/webscr':'https://www.paypal.com/cgi-bin/webscr';
		$this->paypal_nvp_url = ($testMode)?'https://api-3t.sandbox.paypal.com/nvp':'https://api-3t.paypal.com/nvp';
	...
	$str .= '<input type="hidden" name="'.$name.'" value="'.htmlspecialchars($value).'" />'. "\n";
